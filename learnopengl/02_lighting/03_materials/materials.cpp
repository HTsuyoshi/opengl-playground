...
int main()
{
	...
	lightingShader.use();
	lightingShader.setVec3("material.ambient", glm::vec3(1.0f, 0.5f, 0.3f));
	lightingShader.setVec3("material.diffuse", glm::vec3(1.0f, 0.5f, 0.3f));
	lightingShader.setVec3("material.specular", glm::vec3(0.5f, 0.5f, 0.5f));
	lightingShader.setFloat("material.shininess", 32.0f);
	lightingShader.setVec3("light.ambient", glm::vec3(0.1f));
	lightingShader.setVec3("light.diffuse", glm::vec3(0.3f));
