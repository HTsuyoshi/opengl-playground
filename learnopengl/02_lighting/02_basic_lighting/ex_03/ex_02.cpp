...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		lightingShader.setVec3("lightPos", lightPos + glm::vec3(glm::sin(glfwGetTime()), 0.0f, 0.0f));
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, lightPos + glm::vec3(glm::sin(glfwGetTime()), 0.0f, 0.0f));
